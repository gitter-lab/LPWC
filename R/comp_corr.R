...
#'
#' @examples
#' ## upon introducing lags (or shifts) in the data, the correlation is computed
#' ## using comp.corr. However the best.lag is randomly sampled for illustration purpose
...
#'
#' ## another example with actual best.lag output
