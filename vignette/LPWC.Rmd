...
**Timepoints:** The object **timepoints** should be a vector of timepoints when data was collected.
...
- How can I speed up LPWC's selection of the C parameter for the low penalty with a large dataset?
